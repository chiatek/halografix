            ...
            <div className="form-wizard">
                <form id="wizard" action={this.url} target={this.props.type + "-iframe"} method="post">
                    ...
                    <div style={this.state.page === 1 ? {display: "block"} : {display: "none"}}>
                        <h2 className="step-title">1. First thing's first, what will this cost me?</h2>
                        <hr />
                    ...
                    <div style={this.state.page === 2 ? {display: "block"} : {display: "none"}}>
                        <h2 className="step-title">2. Okay, now a little bit about your event.</h2>
                        <hr />
                    ...
                    <div style={this.state.page === 3 ? {display: "block"} : {display: "none"}}>
                        <h2 className="step-title">{this.props.type === "webdesign" ? "2" : "3"}. Now that we got that out of the way, introduce yourself!</h2>
                        <hr />
                    ...
                    <div style={this.state.page === 4 ? {display: "block"} : {display: "none"}}>
                        <h2 className="step-title">{this.props.type === "webdesign" ? "3" : "4"}. Finally, let's wrap things up!</h2>
                        <hr />
